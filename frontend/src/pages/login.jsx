      ...
      <Grid container sx={{ minHeight: '100vh', zIndex: 1 }}>
        ...
        >
          <Typography
            variant="h1"
            sx={{
                fontSize: { xs: 40, sm: 64, md: 80, lg: 120 }, // Increased font size for larger screens
                fontWeight: 'bold',
                color: 'green',
                textAlign: 'center',
                textShadow: '2px 2px 0 black, -2px -2px 0 black, 2px -2px 0 black, -2px 2px 0 black, 0 2px 0 black, 0 -2px 0 black, 2px 0 0 black, -2px 0 0 black', // Black border effect
              }}
          >
            Haritha Agro PNMS
          </Typography>
